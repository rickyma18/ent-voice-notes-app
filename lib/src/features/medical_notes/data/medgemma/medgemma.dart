// lib/src/features/medical_notes/data/medgemma/medgemma.dart
//
...
export 'providers/medgemma_providers.dart';
export 'repositories/medgemma_extractor_repository_impl.dart';
export 'utils/request_id_generator.dart';
