// packages/docsoft_scribe_core/lib/src/prompts/extractor_prompts.dart
//
// Production prompts for clinical fact extraction.
// These are the EXACT prompts used in production - do not modify for harness.

import '../entities/transcript_with_speakers.dart';
import '../repositories/encounter_extractor_repository.dart';
...
3. ros (Review of Systems): Síntomas por aparatos/sistemas.
   ...
   c) FORMATO DE ROS.NEGATIVES (CRÍTICO):
   ...
   d) REGLA CRÍTICA: ROS SOLO TÉRMINOS CLÍNICOS:
      - PROHIBIDO incluir frases coloquiales, verbos descriptivos o expresiones vagas.
      - PROHIBIDO: "da vueltas", "que gire", "se mueve", "siento raro"
      - PERMITIDO: "mareo", "vértigo", "cefalea", "otalgia", "acúfeno"
...
4. pmh/medications/allergies: Listas de antecedentes, medicamentos y alergias.
   ...
   - MEDICAMENTOS: SOLO incluir medicamentos de uso HABITUAL/REGULAR.
     * NO incluir en medications: "ocasional", "a veces", "cuando me duele", "PRN".
...
5. assessment: Diagnóstico o impresión clínica.
   ...
   DIAGNÓSTICOS CONSERVADORES (PROHIBIDO INFERIR):
...
6. plan: Acciones a tomar.
   ...
   REGLA CRÍTICA - PLAN (PROHIBIDO INVENTAR):
